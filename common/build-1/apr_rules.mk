...
#
CFLAGS=-I/bitnami/lamp73stack-linux-x64/output/mysql/include -I/opt/bitnami/common/include -fPIC -m64
CPPFLAGS=-DAI_ADDRCONFIG=0 -I/bitnami/lamp73stack-linux-x64/output/sqlite/include -I/opt/bitnami/common/include -I/bitnami/lamp73stack-linux-x64/output/mysql/include -I/opt/bitnami/common/include/sasl -I/opt/bitnami/common/include
LDFLAGS=-L/bitnami/lamp73stack-linux-x64/output/sqlite/lib -L/bitnami/lamp73stack-linux-x64/output/mysql/include -L/opt/bitnami/common/lib -ldl
LIBS=
DEFS=-DHAVE_CONFIG_H
